...
| L7 Human gate | doctrine (FrankX `CLAUDE.md` hard-stops) · enforced everywhere · in code at the trade-gate (`request_approval` is the human's surface; no token → no execution) |
