# CLAUDE.md
## Baseline Configuration - Unified Agentic Guardrails

Behavioral guidelines to reduce common LLM coding mistakes and enforce senior-grade discipline across all agent sessions.
